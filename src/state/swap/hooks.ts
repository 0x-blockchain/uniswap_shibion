  ...
  const onCurrencySelection = useCallback(
    (field: Field, currency: Currency) => {
      dispatch(
        selectCurrency({
          field,
          currencyId: currency instanceof Token ? currency.address : currency === ETHER ? ETHER.symbol ?? 'BCX' : ''
        })
      )
    },
    [ETHER, dispatch]
...
const BAD_RECIPIENT_ADDRESSES: string[] = [
  '0xEeDeb4111996BF88FBBE495d26dBdDF8EE7E98d0', // v2 factory
  '0xedD8B5e248a739a8Ea9BD048eFe0D3E4E110692e' // v2 router 02
]
